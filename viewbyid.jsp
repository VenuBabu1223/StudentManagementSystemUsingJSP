...
<head>
  ...
  <style>
    ...
    * {margin: 0; padding: 0; box-sizing: border-box; font-family: "Poppins", sans-serif;}
    ...
    body {
      height: 100vh;
      background: url('https://images.unsplash.com/photo-1498079022511-d15614cb1c02?auto=format&fit=crop&w=1400&q=80')
    ...
    button {
      ...
      font-size: 17px; background: linear-gradient(90deg, #00c6ff, #0072ff);
...
<body>
  ...
  <form action="ViewStudent.jsp" method="get" class="form-container">
